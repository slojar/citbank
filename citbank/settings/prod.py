...
ALLOWED_HOSTS = ['api.citmfb.com', 'api.bankpro.ng', 'api.moneyfieldmfb.com']
...
PAYATTITUDE_SETTLEMENT_ACCOUNT_NAME = env('PAYATTITUDE_SETTLEMENT_ACCOUNT_NAME')
PAYATTITUDE_SETTLEMENT_ACCOUNT_BANK_CODE = env('PAYATTITUDE_SETTLEMENT_ACCOUNT_BANK_CODE')
PAYATTITUDE_SETTLEMENT_SENDER_NAME = env('PAYATTITUDE_SETTLEMENT_SENDER_NAME')
PAYATTITUDE_SETTLEMENT_SENDER_BANK_CODE = env('PAYATTITUDE_SETTLEMENT_SENDER_BANK_CODE')
PAYATTITUDE_SETTLEMENT_URL = env('PAYATTITUDE_SETTLEMENT_URL')
PAYATTITUDE_SETTLEMENT_POS_CHARGE = env('PAYATTITUDE_SETTLEMENT_POS_CHARGE')
PAYATTITUDE_SETTLEMENT_WEB_CHARGE = env('PAYATTITUDE_SETTLEMENT_WEB_CHARGE')
PAYATTITUDE_SETTLEMENT_ATM_CHARGE_ONE = env('PAYATTITUDE_SETTLEMENT_ATM_CHARGE_ONE')
PAYATTITUDE_SETTLEMENT_ATM_CHARGE_TWO = env('PAYATTITUDE_SETTLEMENT_ATM_CHARGE_TWO')
